...
First = gg.isPackageInstalled("me.jagar.jokerantiban") if First == false then gg.alert("⛔️ !! السكربت خاص بمشتركين SPIDER فقط يرجى الاشتراك عند @Spider050  !! ⛔️") os.exit() end
...
function gam(...)
JOK12 = gg.multiChoice({"🎯     طيران الاعب طول القيم    🎯","🎯     هيدشوت 50٪    🎯","🎯   هيدشوت 75٪    🎯","➕     صليب صغير       ➕","🎥      منظور ايباد        🎥","🌲ازاله العشب + الاشجار🌱","⁦🌫️⁩      ازالة الضباب       ⁦🌫️⁩","🌌      سماء سوداء       🌌","🗼           انتينا            🗼","⁦⁦ رجوع "}, nil, "╔─━━━━━━━━░░ 🇦🇪SPIDER 🇦🇪 ░░━━━━━━━━─╗\n                    \n                                      للتواصل : @Spider050    \n╚─━━━━━━━━░░ 🇦🇪SPIDER 🇦🇪░░━━━━━━━━─╝")
if JOK12 == nil then
else
...
function gam2(...)
JOK12 = gg.multiChoice({"💯    ثبات سلاح 100٪      💯","🔞         خلطه SPIDER            🔞","🔥      هيدشوت 100٪       🔥","🎯       هيدشوت v2          🎯","💥          انستا هيد            💥","♨️         ايمبوت 50           ♨️","💣️⁩         ماجيك بولت         💣⁩️","🐇    تشغيل قفزه الارنب     🐇","🐰       ايقاف القفزه           🐰","⁦⁦ رجوع"}, nil, "╔─━━━━━━━━░░ 🇦🇪SPIDER 🇦🇪 ░░━━━━━━━━─╗\n                    \n                                      للتواصل : @Spider050    \n╚─━━━━━━━━░░ 🇦🇪SPIDER 🇦🇪░░━━━━━━━━─╝")
if JOK12 == nil then
else
if JOK12[1] == true then
NOREC()
...
gg.editAll("200", 16)
gg.clearResults()
gg.toast("SPIDER Bullet activated!")
end
...
function DHADY(...)
HADY = gg.multiChoice({"🔥       خلطه Spider غير امنه         🔥️","🏅         خلطه Spider امنه             🏅","رجوع"}, nil, (os.date(" ╔─━━━━━━━━░░ 🇦🇪SPIDER 🇦🇪 ░░━━━━━━━━─╗\n               🇦🇪SPIDER 🇦🇪  \n                                      للتواصل : @Spider050   \n╚─━━━━━━━━░░ 🇦🇪SPIDER 🇦🇪░░━━━━━━━━─╝")))
if HADY == nil then
else
if HADY[1] == true then
HS2000()
...
function wlhack(...)
BDYMN = gg.choice({"📂    قائمه الولهاك     📂","📂    قائمه الالوان     📂","❰ ⁦⬅️ [Back - رجوع]⬅️❱"}, nil, "╔─━━━━━━━━░░ 🇦🇪SPIDER 🇦🇪 ░░━━━━━━━━─╗\n                    \n                                      للتواصل : @Spider050    \n╚─━━━━━━━━░░ 🇦🇪SPIDER 🇦🇪░░━━━━━━━━─╝")
if BDYMN == nil then
else
if BDYMN == 1 then
WH()
...
function WH(...)
CLRMN845 = gg.choice({"❰🔴 ʀᴇᴅ ʙᴏᴅʏ 845 🔴❱","❰☣️ ʏᴇʟʟᴏᴡ ʙᴏᴅʏ 845 ☣️❱","❰♎ ɢʀᴇᴇɴ ʙᴏᴅʏ 845 ♎ ❱","❰🔵 ʙʟᴜᴇ ʙᴏᴅʏ 845🔵 ❱","❰⬅️ [Back - رجوع] ⬅️ ❱"}, nil, "╔─━━━━━━━━░░ 🇦🇪SPIDER 🇦🇪 ░░━━━━━━━━─╗\n                    \n                                      للتواصل : @Spider050    \n╚─━━━━━━━━░░ 🇦🇪SPIDER 🇦🇪░░━━━━━━━━─╝")
...
function CLR855(...)
CLRMN855 = gg.choice({"❰♎ ɢʀᴇᴇɴ ʙᴏᴅʏ 855 ♎❱","❰☣️ ʏᴇʟʟᴏᴡ ʙᴏᴅʏ 855☣️❱","❰🔵 ʙʟᴜᴇ ʙᴏᴅʏ 855 🔵❱","❰🔴 ʀᴇᴅ ʙᴏᴅʏ 855 🔴❱","❰⬅️ [Back - رجوع]⬅️❱"}, nil, "╔─━━━━━━━━░░ 🇦🇪SPIDER 🇦🇪 ░░━━━━━━━━─╗\n               🇦🇪SPIDER 🇦🇪  \n                                      للتواصل : @Spider050    \n╚─━━━━━━━━░░ 🇦🇪SPIDER 🇦🇪░░━━━━━━━━─╝")
...
function standsco(...)
standhadiM = gg.multiChoice({" ⬆️⁩ تشغيل سيت سكوب ⁦⬆️ ⁩⁩"," 🔽 ايقاف سيت سكوب ⁦🔽 ⁩⁩"," ⬆️⁩ تشغيل ستاند سكوب ⁦⬆️ ⁩⁩"," 🔽 ايقاف ستاند سكوب ⁦🔽 ⁩⁩"," ⬆️⁩ تشغيل ستاند شوت ⁦⬆️ ⁩⁩"," 🔽 ايقاف ستاند شوت ⁦🔽 ⁩⁩","⁦⁦ رجوع"}, nil, "╔─━━━━━━━━░░ 🇦🇪SPIDER 🇦🇪 ░░━━━━━━━━─╗\n                    \n                                      للتواصل : @Spider050    \n╚─━━━━━━━━░░ 🇦🇪SPIDER 🇦🇪░░━━━━━━━━─╝")
...
function speed(...)
speedM = gg.choice({" 『 طيران اللعب تفعل في الجيم  』"," 『 اصلاح دمج الاسلحه 』"," 『 تشغيل سبيد فلاش 』"," 『 ايقاف سبيد فلاش  』"," 『 تشغيل سرعة لاعب متوسط 』"," 『 تشغيل سبيد نوك    』"," 『🚙 تفعيل سرعة الجيب  』"," 『🚗ايقاف سرعة الداسيا   』"," 『🚀 نزول سريع PC    』"," 『 ⁦☂️⁩نزول سريع بارشوت    』"," 『🚙 سرعة الجيب بنزين لاينتهي  』","🚙             قفز الجيب             🚙","🚗             قفز داسيا              🚗","رجوع"}, nil, "╔─━━━━━━━━░░ 🇦🇪SPIDER 🇦🇪 ░░━━━━━━━━─╗\n                    \n                                      للتواصل : @Spider050    \n╚─━━━━━━━━░░ 🇦🇪SPIDER 🇦🇪░░━━━━━━━━─╝")
if speedM == nil then
else
if speedM == 1 then
HADYASD()
